    ...
    .then((data) => {
      ...
      if (data === "error") {
        ...
        data.forEach((ele) => {
          ...
          <div>
          <label         class="cli-vehiculos-titulo">Patente : </label>
          <span class="cli-vehiculos-detalle">  ${ele.patente} </span>
          </div>
          <div>
          <label         class="cli-vehiculos-titulo">Marca   : </label>
          <span class="cli-vehiculos-detalle">${ele.marca} </span>
          </div>
          <div>
          <label         class="cli-vehiculos-titulo">Modelo : </label>
          <span class="cli-vehiculos-detalle">${ele.modelo}</span>
          </div>
          <div>
          <label         class="cli-vehiculos-titulo">KM    : </label>
          <span class="cli-vehiculos-detalle">${ele.km} </span>
          </div>
          <div>
          <label         class="cli-vehiculos-titulo">Tanque  : </label>
          <span class="cli-vehiculos-detalle">${ele.tanque} </span>
          </div>
          <div>
          <label         class="cli-vehiculos-titulo">Detalles : </label>
