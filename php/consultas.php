<?php
  ...
  // echo 'reg-trb  '.$cant_trb.'<br>';
    ...
    $filap=mysqli_fetch_array($constrb);
      ...
      $datosVP[$i] = array('id_vehiculo' => $id_vehiv, 'id_cliente' => $id_clie, 'patente' => $patIng, 'observ' => $observ, 'fecha_trab' => $fecha_trab, 'fecha_entrega' => $fecha_entr, 'factura' => $factura, 'presupuesto' => $presupuesto);
      }
      $datosP=$datosVP;
